...
<body>
	...
	<div class="flex flex-wrap items-center justify-center gap-4 mt-6 z-10">
		<a href="https://github.com/amir52534/royal-gateway" target="_blank" class="flex items-center gap-2 px-4 py-2 border border-amber-800/40 text-amber-400 bg-black/40 hover:bg-amber-900/20 rounded-full text-sm font-bold backdrop-blur-sm transition">گیت‌هاب</a>
	...
	<script>
		...
		window.startDeploy=startDeploy; window.toggleToken=toggleToken; window.toggleUpdateModal=toggleUpdateModal; window.checkExistingPanels=checkExistingPanels; window.updatePanel=updatePanel; window.deletePanel=deletePanel;
	</script>
</body>
</html>`;
}